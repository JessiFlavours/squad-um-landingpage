...
<head>
    ...
    <link rel="stylesheet" href="/src/views/tasks/style.css">
</head>
    ...
    <div class="page-shell">
        ...
        <header class="navbar">
            ...
            <div class="nav-actions">
                <a class="btn-tasks" href="/home/tasks">Tarefas</a>
                <a class="btn-users" href="/home/users">Usuários</a>
...
function populateAssigneeFilter(users) {
    ...
    return allTasks.filter((tarefa) => {
        ...
        async function atualizarStatusNaLista(tarefa, novoStatus) {
            const response = await fetch(`/tasks/${tarefa.id}`, {
                method: 'PUT',
                headers: { 'Authorization': 'Bearer ' + token, 'Content-Type': 'application/json' },
